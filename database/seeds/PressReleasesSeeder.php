...
class PressReleasesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('releases')->insert([
          ...
          'image' => 'boston-underground-film.jpg',
