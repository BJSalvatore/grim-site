<div class="jumbotron jumbotron-fluid m-0 p-0" style="background-color: #FF8C00; height: 440px">
  <div class="row no-gutters">
    <div class="d-inline-flex col-sm-3">
      <div class="container d-flex img-responsive">
        <img id="logo" src="{{ asset('assets/images/TheGrimLogoTransparent.png') }}" style="width: auto; height: 300px; margin-top: 75px;"></img>
      </div>
    </div>
