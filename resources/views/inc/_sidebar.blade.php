<div id="sidebar" class="container-fluid text-light bg-dark d-none d-sm-block d-md-block d-lg-block">
        <div class="col p-2">
              <p>New Release!</p>
        ...
        <div #id="recordLabelLogo" class="col-sm d-none d-sm-none d-md-none d-lg-block d-xl-block mb-3">
