<div class="d-flex justify-content-center text-light bg-dark" style="margin-left: 0px; margin-top: 0px; height: 100%;">
  <div class= "sidenav navbar-right">
    <div class="d-flex flex-column col-sm-4">
      <div class="container">
        <h3>New Release!</h3>
        <img id="newLP" class="img-fluid" src="{{ asset('assets/images/TheGrimNuclearWorldOrder.jpg') }}"style="min-width: 210px; height: auto; margin-top: 0px; margin-left: 0px"></img>
      </div>
      <div class="container">
