  ...
  <div class = "d-flex flex-row">
    ...
    <div class="col-lg-8 mt-3 mb-3">
      ...
      <table class="table">
        ...
        <tbody>
          <tr>
            <td><img id="thumbnail" class="d-flex img-responsive" src="{{ asset('storage/merch/orange_album.jpg') }}"></img></td>
          ...
          <tr>
            <td><img id="thumbnail" class="d-flex img-responsive" src="{{ asset('storage/merch/face_of_betrayal.jpg') }}"></img></td>
          ...
          <tr>
            <td><img id="thumbnail" class="d-flex img-responsive" src="{{ asset('storage/merch/best_of_album.jpg') }}"></img></td>
          ...
          <tr>
            <td><img id="thumbnail" class="d-flex img-responsive" src="{{ asset('storage/merch/cop_killer_ep.jpg') }}"></img></td>
            <td>Cop Killer</td>
            <td>7" EP</td>
            <td>2017</td>
            <td>Felony Records</td>
          </tr>
          <td><img id="thumbnail" class="d-flex img-responsive" src="{{ asset('storage/merch/NuclearWorldOrder.jpg') }}"></img></td>
